$(function() {
	...
	//chart success
	new ApexCharts(document.querySelector("#w-chart-success"), e).render();
	e = {
		series: [{
			name: "w-chart-success",
			data: [240, 160, 671, 414, 555, 257, 901, 613, 727, 414, 555, 257]
		}],
		chart: {
			type: "bar",
	...
	//chart primary
	new ApexCharts(document.querySelector("#w-chart-primary"), e).render();
	e = {
		series: [{
			name: "w-chart-primary",
			data: [240, 160, 671, 414, 555, 257, 901, 613, 727, 414, 555, 257]
		}],
		chart: {
			type: "bar",
