...
// Create product 
	if(isset($_POST['submit']))
	{
        ...
        || empty($productQuantity) || empty($productPV) || empty($productPromotion))
        {
        ...
        elseif($ImgCheck=='png' || $ImgCheck=='jpg' || $ImgCheck=='jpeg')
        {
            ...
            $q="INSERT INTO `product`(`main_category`, `sub_category`, `product_title`, `product_description`, `product_price`, `product_strike_price`, `product_image`, `product_quantity`, `product_pv`, `product_promotion`) 
                VALUES ('$mainCategory','$subCategory','$productTitle','$productDescription','$productPrice','$productStrikePrice','$ImgDestinationFile','$productQuantity','$productPV','$productPromotion')";
