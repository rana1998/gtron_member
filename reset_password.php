                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                ...
                                <div class="login-separater text-center mb-4"> <span>RESET YOUR PASSWORD</span>
                                    <hr/>
                                </div>
                                <div class="form-body">
                                    ...
                                    <form class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" class="btn bg-gradient-ibiza text-white"><i class="bx bxs-lock-open"></i>Reset password</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
