...
if(isset($_GET['user_name']) and !empty($_GET['user_name']))
{
    ...
    if($resultRow !=1)
    {
        $_SESSION['errorMsg'] = 'Error Wrong Sponsor Name';
...
<html lang="en">
  <head>
    ...
    ></script>
    <link rel="stylesheet" href="login-signup/static-page-signup.css" />
    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <form id="formSignUp" action="#" class="sign-in-form">
            ...
            <div class="input-field">
              ...
              <input type="text" disabled id="sponsor_name" name="sponsor_name" autocomplete="off" value="<?=$userName?>"  />
            ...
            <div class="input-field">
              ...
              <input type="password" id="password" name="password" placeholder="Password" title="Min 8, Special Character, Integer, Upper Case"/>
...
//password visibility with eye code start
...
//password visibility with eye code end 
