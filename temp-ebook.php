...
include 'header.php'; 
    ...
    $sql1 = "SELECT * FROM package_details where user_name = '$user_name' and status ='Approved'";
...
else
{
  ...
  <div class="page-content">
    <div class="row pt-2 pb-2"><div class="col-md-12"><p class="text-warning">Please Purchase Package</p></div></div></div>';
    exit();
}
